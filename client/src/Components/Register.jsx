...
import email_Icon from "../image/tl.webp"; // Email icon image
import phoneicon from "../image/phone-call-icon-symbol-in-trendy-flat-style-call-icon-sign-for-app-logo-web-call-icon-flat-illustration-telephone-symbol-vector.jpg"; // Phone icon image
import user from "../image/login-avatar.png"; // User icon
