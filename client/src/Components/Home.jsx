...
// -----------------------------------------
  ...
  return (
    <div className="w-full bg-gray-300 mt-32 dark:bg-gray-900 dark:text-white transition">
      <Helmet>
      ...
      {/* ------------------------------------ */}
      <section className="rounded py-2 m-4">
        <div className="grid md:grid-cols-2 gap-2 items-center mt-container mx-auto">
